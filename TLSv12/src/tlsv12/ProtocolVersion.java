...
/**
 * Type safe enum for an SSL/TLS protocol version. Instances are obtained using
 * the static factory methods or by referencing the static members in this
 * class. Member variables are final and can be accessed without accessor
 * methods.
 *
 * There is only ever one instance per supported protocol version, this means ==
 * can be used for comparision instead of equals() if desired.
 *
 * Checks for a particular version number should generally take this form:
 *
 * if (protocolVersion.v >= ProtocolVersion.TLS10) { // TLS 1.0 code goes here }
 * else { // SSL 3.0 code here }
 *
...
public final class ProtocolVersion implements Comparable<ProtocolVersion> {
    ...
    final static ProtocolVersion MIN = TLS12;
    ...
    final static ProtocolVersion DEFAULT_HELLO = TLS12;
     ...
     *                if name is null or does not identify a supported protocol
     */
