...
/*
 * A simple class to congregate alerts, their definitions, and common support
 * methods.
 */
...
final class Alerts {
     ...
     * 
     * We may not use them all in our processing, but if someone sends us one,
     * we can at least convert it to a string for the user.
     */
    ...
    /*
     * Try to be a little more specific in our choice of exceptions to throw.
     */
