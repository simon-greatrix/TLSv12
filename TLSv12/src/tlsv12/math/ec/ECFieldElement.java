...
import tlsv12.math.raw.Mod;
import tlsv12.math.raw.Nat;
...
public abstract class ECFieldElement implements ECConstants {
    ...
    public byte[] getEncoded() {
        return BigIntegers.asUnsignedByteArray((getFieldSize() + 7) / 8,
                toBigInteger());
    }
    ...
    public static class Fp extends ECFieldElement {
        ...
        public ECFieldElement invert() {
            // TODO Modular inversion can be faster for a (Generalized) Mersenne
            // Prime.
        ...
        public ECFieldElement sqrt() {
            ...
            // note: even though this class implements ECConstants don't be
            // tempted to
            // remove the explicit declaration, some J2ME environments don't
            // cope.
            ...
            do {
                ...
                do {
                    P = new BigInteger(q.bitLength(), rand);
                        ...
                        || !modReduce(P.multiply(P).subtract(fourX)).modPow(
                                legendreExponent, q).equals(qMinusOne) );
        ...
        private BigInteger[] lucasSequence(BigInteger P, BigInteger Q,
                BigInteger k) {
    ...
    public static class F2m extends ECFieldElement {
         ...
         *            represents the reduction polynomial <code>f(z)</code>.
         * @param x
         *            The BigInteger representing the value of the field
         *            element.
        ...
        /**
         * Checks, if the ECFieldElements <code>a</code> and <code>b</code> are
         * elements of the same field <code>F<sub>2<sup>m</sup></sub></code>
         ...
         *             if <code>a</code> and <code>b</code> are not elements of
         *             the same field <code>F<sub>2<sup>m</sup></sub></code>
         *             (having the same representation).
         */
        ...
        public ECFieldElement invert() {
            return new ECFieldElement.F2m(this.m, this.ks, this.x.modInverse(m,
                    ks));
        }
