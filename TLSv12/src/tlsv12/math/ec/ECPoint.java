...
public abstract class ECPoint {
    ...
    protected static ECFieldElement[] getInitialZCoords(ECCurve curve) {
        ...
        int coord = null == curve ? ECCurve.COORD_AFFINE
                : curve.getCoordinateSystem();
    ...
    protected int getCurveCoordinateSystem() {
        // Cope with null curve, most commonly used by implicitlyCa
        return null == curve ? ECCurve.COORD_AFFINE
                : curve.getCoordinateSystem();
    }
     ...
     * 
     * Caution: depending on the curve's coordinate system, this may not be the
     * same value as in an affine coordinate system; use normalize() to get a
     * point where the coordinates have their affine values, or use
     * getAffineXCoord() if you expect the point to already have been
     * normalized.
     * 
     ...
     * same value as in an affine coordinate system; use normalize() to get a
     * point where the coordinates have their affine values, or use
     * getAffineYCoord() if you expect the point to already have been
     * normalized.
     * 
    ...
    public boolean isNormalized() {
        ...
        return coord == ECCurve.COORD_AFFINE
                || coord == ECCurve.COORD_LAMBDA_AFFINE || isInfinity()
                || zs[0].isOne();
    }
    ...
    public ECPoint scaleX(ECFieldElement scale) {
        return isInfinity() ? this : getCurve().createRawPoint(
                getRawXCoord().multiply(scale), getRawYCoord(),
                getRawZCoords(), this.withCompression);
    }


    public ECPoint scaleY(ECFieldElement scale) {
        return isInfinity() ? this : getCurve().createRawPoint(getRawXCoord(),
    ...
    public boolean equals(ECPoint other) {
        ...
        if( n1 && n2 ) {
            ...
            // TODO This is a little strong, really only requires
            // coZNormalizeAll to get Zs equal
    ...
    public static class Fp extends AbstractFp {
        ...
        protected ECPoint detach() {
            return new ECPoint.Fp(null, this.getAffineXCoord(),
                    this.getAffineYCoord());
        }


        public ECFieldElement getZCoord(int index) {
            if( index == 1
                    && ECCurve.COORD_JACOBIAN_MODIFIED == this.getCurveCoordinateSystem() ) {
        ...
        public ECPoint add(ECPoint b) {
            ...
            case ECCurve.COORD_HOMOGENEOUS: {
                ...
                ECFieldElement w = Z1IsOne ? Z2 : Z2IsOne ? Z1
                        : Z1.multiply(Z2);
                ECFieldElement vSquared = v.square();
                ECFieldElement vCubed = vSquared.multiply(v);
                ECFieldElement vSquaredV2 = vSquared.multiply(v2);
                ECFieldElement A = u.square().multiply(w).subtract(vCubed).subtract(
                        two(vSquaredV2));

                ECFieldElement X3 = v.multiply(A);
                ECFieldElement Y3 = vSquaredV2.subtract(A).multiplyMinusProduct(
                        u, u2, vCubed);
                ECFieldElement Z3 = vCubed.multiply(w);

                return new ECPoint.Fp(curve, X3, Y3,
                        new ECFieldElement[] { Z3 }, this.withCompression);
            }
            ...
            case ECCurve.COORD_JACOBIAN_MODIFIED: {
                ...
                if( coord == ECCurve.COORD_JACOBIAN_MODIFIED ) {
                    // TODO If the result will only be used in a subsequent
                    // addition, we don't need W3
                    ECFieldElement W3 = calculateJacobianModifiedW(Z3,
                            Z3Squared);
        ...
        public ECPoint twice() {
            ...
            case ECCurve.COORD_AFFINE: {
                ...
                ECFieldElement gamma = three(X1Squared).add(
                        this.getCurve().getA()).divide(two(Y1));
            ...
            case ECCurve.COORD_HOMOGENEOUS: {
                ...
                ECFieldElement Y3 = _4B.subtract(h).multiply(w).subtract(
                        two(_2t.square()));
            ...
            case ECCurve.COORD_JACOBIAN: {
                ...
                if( a4Neg.toBigInteger().equals(BigInteger.valueOf(3)) ) {
                    ...
                    // S = two(doubleProductFromSquares(X1, Y1Squared,
                    // X1Squared, T));
                    S = four(X1.multiply(Y1Squared));
                }

                ECFieldElement X3 = M.square().subtract(two(S));
                ECFieldElement Y3 = S.subtract(X3).multiply(M).subtract(
                        eight(T));
                ...
                // Alternative calculation of Z3 using fast square
                // ECFieldElement Z3 = doubleProductFromSquares(Y1, Z1,
                // Y1Squared, Z1Squared);
        ...
        public ECPoint twicePlus(ECPoint b) {
            ...
            case ECCurve.COORD_AFFINE: {
                ...
                /*
                 * Optimized calculation of 2P + Q, as described in "Trading
                 * Inversions for Multiplications in Elliptic Curve
                 * Cryptography", by Ciet, Joye, Lauter, Montgomery.
                 */
                ...
                ECFieldElement L2 = two(Y1).multiply(X).multiply(dx).multiply(I).subtract(
                        L1);
                ECFieldElement X4 = (L2.subtract(L1)).multiply(L1.add(L2)).add(
                        X2);
        ...
        public ECPoint threeTimes() {
            ...
            case ECCurve.COORD_AFFINE: {
                ...
                ECFieldElement Z = three(X1.square()).add(
                        this.getCurve().getA());
            ...
            default: {
                // NOTE: Be careful about recursions between twicePlus and
                // threeTimes
        ...
        protected ECPoint.Fp twiceJacobianModified(boolean calculateW) {
            ...
            return new ECPoint.Fp(this.getCurve(), X3, Y3,
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected AbstractF2m(ECCurve curve, ECFieldElement x,
                ECFieldElement y, ECFieldElement[] zs) {
            super(curve, x, y, zs);
        }
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            if( coord == ECCurve.COORD_LAMBDA_PROJECTIVE ) {
                ...
                if( X.isZero() ) {
                    // NOTE: For x == 0, we expect the affine-y instead of the
                    // lambda-y
                ...
                if( ZIsOne ) {
                    ...
                    // TODO If sqrt(b) is precomputed this can be simplified to
                    // a single square
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(ECCurve curve, ECFieldElement x, ECFieldElement y,
            ...
            if( x != null ) {
                ...
                if( curve != null ) {
                    ECFieldElement.F2m.checkFieldElements(this.x,
                            this.curve.getA());
                }
            }
        ...
        protected ECPoint detach() {
            return new ECPoint.F2m(null, this.getAffineXCoord(),
                    this.getAffineYCoord()); // earlier JDK
        }
        ...
        public ECFieldElement getYCoord() {
            ...
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                ...
                // Y is actually Lambda (X + Y/X) here; convert to affine value
                // on the fly
        ...
        public ECPoint scaleX(ECFieldElement scale) {
            ...
            case ECCurve.COORD_LAMBDA_AFFINE: {
                ...
                ECFieldElement X = this.getRawXCoord(), L = this.getRawYCoord(); // earlier
                                                                                 // JDK

                ECFieldElement X2 = X.multiply(scale);
                ECFieldElement L2 = L.add(X).divide(scale).add(X2);

                return this.getCurve().createRawPoint(X, L2,
                        this.getRawZCoords(), this.withCompression); // earlier
                                                                     // JDK
            }
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                // Y is actually Lambda (X + Y/X) here
                ...
                return this.getCurve().createRawPoint(X2, L2,
                        new ECFieldElement[] { Z2 }, this.withCompression); // earlier
                                                                            // JDK
            }
            default: {
        ...
        public ECPoint.F2m addSimple(ECPoint.F2m b) {
            ...
            case ECCurve.COORD_HOMOGENEOUS: {
                ...
                ECFieldElement A = uv.multiplyPlusProduct(U, VSq, curve.getA()).multiply(
                        W).add(VCu);

                ECFieldElement X3 = V.multiply(A);
                ECFieldElement VSqZ2 = Z2IsOne ? VSq : VSq.multiply(Z2);
                ECFieldElement Y3 = U.multiplyPlusProduct(X1, V, Y1).multiplyPlusProduct(
                        VSqZ2, uv, A);
            ...
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                ...
                return new ECPoint.F2m(curve, X3, L3,
                        new ECFieldElement[] { Z3 }, this.withCompression);
            }
            default: {
                throw new IllegalStateException("unsupported coordinate system");
         ...
         * 
         * @see
         * org.bouncycastle.math.ec.ECPoint#subtract(org.bouncycastle.math.ec
         * .ECPoint)
         */
        public ECPoint subtract(ECPoint b) {
            checkPoints(this, b);
         ...
         * multiplication algorithms, because there all points are a multiple of
         * the same point and hence the checks can be omitted.
         * 
         * @param b
         *            The other <code>ECPoints.F2m</code> to subtract from
         *            <code>this</code>.
         * @return <code>this - b</code>
         */
        ...
        public ECPoint twice() {
            ...
            case ECCurve.COORD_HOMOGENEOUS: {
                ...
                ECFieldElement h = sv.multiplyPlusProduct(S, vSquared,
                        curve.getA());
            ...
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                ...
                if( b.bitLength() < (curve.getFieldSize() >> 1) ) {
                    ...
                    if( b.isOne() ) {
                        ...
                        // TODO Can be calculated with one square if we
                        // pre-compute sqrt(b)
        ...
        public ECPoint twicePlus(ECPoint b) {
            ...
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                ...
                ECFieldElement T = curve.getA().multiply(Z1Sq).add(L1Sq).add(
                        L1Z1);
                ECFieldElement L2plus1 = L2.addOne();
                ECFieldElement A = curve.getA().add(L2plus1).multiply(Z1Sq).add(
                        L1Sq).multiplyPlusProduct(T, X1Sq, Z1Sq);
                ...
                ECFieldElement L3 = A.add(B).square().multiplyPlusProduct(T,
                        L2plus1, Z3);
        ...
        public ECPoint negate() {
            ...
            case ECCurve.COORD_HOMOGENEOUS: {
                ...
                return new ECPoint.F2m(curve, X, Y.add(X),
                        new ECFieldElement[] { Z }, this.withCompression);
            }
            case ECCurve.COORD_LAMBDA_AFFINE: {
            ...
            case ECCurve.COORD_LAMBDA_PROJECTIVE: {
                ...
                return new ECPoint.F2m(curve, X, L.add(Z),
                        new ECFieldElement[] { Z }, this.withCompression);
            }
            default: {
                throw new IllegalStateException("unsupported coordinate system");
