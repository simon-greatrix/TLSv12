 ...
 * nonadjacent form (WTNAF). The algorithms are based on the paper
 * "Improved Algorithms for Arithmetic on Anomalous Binary Curves" by Jerome A.
 * Solinas. The paper first appeared in the Proceedings of Crypto 1997.
 */
class Tnaf {
     ...
     * time. When changing this value, the <code>&alpha;<sub>u</sub></code>'s
     * must be computed differently, see e.g.
     * "Guide to Elliptic Curve Cryptography", Darrel Hankerson, Alfred Menezes,
     ...
     * of TNAFs.
     */
    public static final byte[][] alpha0Tnaf = { null, { 1 }, null,
            { -1, 0, 1 }, null, { 1, 0, 1 }, null, { -1, 0, 0, 1 } };
     ...
     * of TNAFs.
     */
    public static final byte[][] alpha1Tnaf = { null, { 1 }, null,
            { -1, 0, 1 }, null, { 1, 0, 1 }, null, { -1, 0, 0, -1 } };
     ...
     * @param lambda
     *            The element <code>&lambda;</code> of
     *            <code><b>Z</b>[&tau;]</code>.
     ...
     *             if <code>lambda0</code> and <code>lambda1</code> do not have
     *             same scale.
     */
    ...
    /**
     * Approximate division by <code>n</code>. For an integer <code>k</code>,
     * the value <code>&lambda; = s k / n</code> is computed to <code>c</code>
     * bits of accuracy.
     * 
     * @param k
     ...
     *            <code>V<sub>k</sub></code>, otherwise
     *            <code>U<sub>k-1</sub></code> and <code>U<sub>k</sub></code>.
     ...
     * 
     * @param curve
     *            The elliptic curve for which to compute
     *            <code>s<sub>0</sub></code> and <code>s<sub>1</sub></code>.
     * @throws IllegalArgumentException
     *             if <code>curve</code> is not a Koblitz curve (Anomalous
     *             Binary Curve, ABC).
     */
    public static BigInteger[] getSi(ECCurve.F2m curve) {
        if( !curve.isKoblitz() ) {
            throw new IllegalArgumentException(
                    "si is defined for Koblitz curves only");
        }
    ...
    /**
     * Multiplies a {@link tlsv12.math.ec.ECPoint.F2m ECPoint.F2m} by an element
     * <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using the
     * <code>&tau;</code>-adic NAF (TNAF) method, given the TNAF of
     * <code>&lambda;</code>.
     * 
     * @param p
