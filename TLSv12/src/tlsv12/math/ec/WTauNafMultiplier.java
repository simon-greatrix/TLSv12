...
public class WTauNafMultiplier extends AbstractECMultiplier {
    ...
    /**
     * Multiplies a {@link tlsv12.math.ec.ECPoint.F2m ECPoint.F2m} by
     * <code>k</code> using the reduced <code>&tau;</code>-adic NAF (RTNAF)
     * method.
     * 
     * @param p
    ...
    protected ECPoint multiplyPositive(ECPoint point, BigInteger k) {
        ...
        return multiplyWTnaf(p, rho, curve.getPreCompInfo(p, PRECOMP_NAME), a,
                mu);
    }
    ...
    /**
     * Multiplies a {@link tlsv12.math.ec.ECPoint.F2m ECPoint.F2m} by an element
     * <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using the window
     * <code>&tau;</code>-adic NAF (TNAF) method, given the WTNAF of
     * <code>&lambda;</code>.
     * 
     * @param p
     *            The ECPoint.F2m to multiply.
    ...
    private static ECPoint.F2m multiplyFromWTnaf(ECPoint.F2m p, byte[] u,
        ...
        ECPoint.F2m[] pu;
        if( (preCompInfo == null)
                || !(preCompInfo instanceof WTauNafPreCompInfo) ) {
