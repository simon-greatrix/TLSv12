...
public class DERApplicationSpecific extends ASN1Primitive {
    ...
    int encodedLength() throws IOException {
        return StreamUtil.calculateTagLength(tag)
                + StreamUtil.calculateBodyLength(octets.length) + octets.length;
    }
    ...
    boolean asn1Equals(ASN1Primitive o) {
        ...
        return isConstructed == other.isConstructed && tag == other.tag
