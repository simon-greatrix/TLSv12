...
/**
 * A list of CipherSuites. Also maintains the lists of supported and default
 * ciphersuites and supports I/O from handshake streams.
 *
...
final class CipherSuiteList {
    ...
    /**
     * Construct a CipherSuiteList from a array of names. We don't bother to
     * eliminate duplicates.
     *
     * @exception IllegalArgumentException
     *                if the array or any of its elements is null or if the
     *                ciphersuite name is unrecognized or unsupported using
    ...
    /**
     * Read a CipherSuiteList from a HandshakeInStream in V3 ClientHello format.
     * Does not check if the listed ciphersuites are known or supported.
     */
    ...
    boolean containsEC() {
        if( containsEC == null ) {
            for(CipherSuite c:cipherSuites) {
                ...
                case K_ECDHE_RSA:
                case K_ECDH_ANON:
                    containsEC = Boolean.TRUE;
                    return true;
                default:
                    break;
                }
            }
            containsEC = Boolean.FALSE;
        }
        return containsEC.booleanValue();
    }


    /**
     * Return a reference to the internal Collection of CipherSuites. The
