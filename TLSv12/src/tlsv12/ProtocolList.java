 ...
 * Instances of this class are immutable. Some member variables are final and
 * can be accessed directly without method accessors.
 *
...
final class ProtocolList {
     ...
     * SSLv2Hello is not a real protocol version we support, we always return
     * false for it.
     */
     ...
     *
     * Return the lower of the protocol version of that suggested by the
     * <code>protocolVersion</code> and the highest version of this protocol
     * list, or null if no protocol version is available.
     *
     * The method is used by TLS server to negotiated the protocol version
     * between client suggested protocol version in the client hello and
