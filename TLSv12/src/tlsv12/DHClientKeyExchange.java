...
/*
 * Message used by clients to send their Diffie-Hellman public keys to servers.
 * 
...
final class DHClientKeyExchange extends HandshakeMessage {
    ...
    /*
     * This value may be empty if it was included in the client's certificate
     * ...
     */
    ...
    /*
     * Either pass the client's public key explicitly (because it's using DHE or
     * DH_anon), or implicitly (the public key was in the certificate).
     */
    ...
    /*
     * Get the client's public key either explicitly or implicitly. (It's ugly
     * to have an empty record be sent in the latter case, but that's what the
