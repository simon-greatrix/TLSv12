...
/**
 * SSL/TLS records, as pulled off (and put onto) a TCP stream. This is the base
 * interface, which defines common information and interfaces used by both Input
 * and Output records.
 *
...
interface Record {
    ...
    static final boolean enableCBCProtection = Debug.getBooleanProperty(
     ...
     */
    static final int maxDataSizeMinusOneByteRecord = maxDataSize // max data
                                                                 // size
     ...
     */
    static final int maxLargeRecordSize = maxRecordSize // Max size with a
                                                        // conforming
                                                        // implemenation
